...
class Invoice(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.cgst_amount = Decimal(self.cgst / 100) * Decimal(self.total_amount_invoice)
        self.sgst_amount = Decimal(self.sgst / 100) * Decimal(self.total_amount_invoice)
        self.total_amount_payable_invoice = Decimal(self.cgst_amount) + Decimal(self.sgst_amount) + self.total_amount_invoice
